...
const demoDashboard: DashboardOverview = {
  ...
  verified_count: 0,
  fact_count: 2964,
  documents_with_facts: 460,
  coverage_percentage: 59.7,
  average_confidence: 0.649,
  ...
  fact_types: [
    ...
    count: Number(count),
    percentage: Math.round((Number(count) / 2964) * 1000) / 10,
  })),
  latest_documents: [],
};
          ...
          {view === "overview" && (
            <div className="view-stack">
              <section className="kpi-grid">
                ...
                <article className="kpi-card"><div className="kpi-icon gold"><Icon name="chart" /></div><div><span>Bilgi kapsaması</span><strong>%{dashboard.coverage_percentage.toLocaleString("tr-TR")}</strong><small>{formatNumber(dashboard.documents_with_facts)} belgede yapılandırılmış alan</small></div></article>
